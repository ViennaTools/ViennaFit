...
class ParameterPlotter(BasePlotter):
    ...
    def _plotParameterPositions(self, data: StudyData, outputDir: str,
                                skipParameters: Optional[List[str]] = None) -> Optional[str]:
        ...
        ax.set_yticklabels([self._formatParameterName(paramNames[numParams - 1 - i])
